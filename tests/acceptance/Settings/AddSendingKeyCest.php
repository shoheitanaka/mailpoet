...
class AddSendingKeyCest {
  public function addMailPoetSendingKey(\AcceptanceTester $i, Scenario $scenario) {
    ...
    $i->fillField(['id' => 'mailpoet-set-from-address-modal-input'], 'mailpoet-phoenix-test@mailinator.com');
    $i->click('Save', '.set-from-address-modal');
    ...
    $i->waitForText('A test email was sent to mailpoet-phoenix-test@mailinator.com');
